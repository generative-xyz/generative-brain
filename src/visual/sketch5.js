...
function preloadingSetup() {
  ...
  colorPalette = [['#ffffff','#231f20','#231f20'],                                                  // 1
                  ...
                  ['#c33b41','#580003','#580003'],                                                  // 4
                  ['#ec642a','#ffff8b','#ffff8b'],                                                  // 5
                  ['#f6b941','#2E2E2E','#2E2E2E'],                                                  // 6
                  ['#45daaa','#012221','#012221'],                                                  // 7
                  ['#00b8ff','#feff50','#feff50'],                                                  // 8
                  ['#07142b','#31669b','#31669b'],                                                  // 9
                  ['#3d1460','#df678c','#df678c'],                                                  // 10
                  ['#704f38','#f0bd90','#f0bd90'],                                                  // 11
                  ['#8f5b62','#ead0d0','#ead0d0'],                                                  // 12
                  ['#eae4cb','#508cac','#508cac'],                                                  // 13
                  ['#ffc6cc','#cc313d','#cc313d'],                                                  // 14
                  ['#8dc63f','#078513','#078513'],                                                  // 15
                  ['#B5CEDA','#00457c','#00457c'],                                                  // 16
                  ['#476930','#c8b88a','#c8b88a'],                                                  // 17
